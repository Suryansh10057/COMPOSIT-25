...
export default function RegisterExcavate() {
    const userData = JSON.parse(localStorage.getItem("COMPOSITuser"))
    const participantId = userData._id
    const [registerExcavateData, setRegisterExcavateData] = useState({});
    ...
    const handleChange = (event) => {
        setRegisterExcavateData({
            ...registerExcavateData,
                ...
                <div className="d-table-cell">
                    <div className="signup-form">
                        ...
                        <form>
                            ...
                            <button type="submit" className="btn btn-secondary" onClick={(event) => handleSubmit(event, "excavate")}>Register</button>
                            <button type="reset" className="btn-modal btn-primary">Reset</button>
                            <p>Already registered for Excavate? <Link to="/events">Register for other events.</Link></p>
                        </form>
                    </div>
                </div>
            </div>
