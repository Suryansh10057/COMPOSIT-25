...
export default function RegisterTechtoon() {
    ...
    const onClickHandler = async (e, eventName) => {
        e.preventDefault()
        try {
            await axios.post(`${process.env.REACT_APP_API_KEY}/${eventName}/${participantId}`, participantId)
                ...
                <div className="d-table-cell">
                    <div className="signup-form">
                        ...
                        <form>
                            ...
                            <button type="submit" className="btn-modal btn-primary" onClick={(event) => onClickHandler(event, "techtoon")}>Register</button>
                            <button type="reset" className="btn-modal btn-primary">Reset</button>
                            <p>Already registered for Techtoon? <Link to="/events">Register for other events.</Link></p>
                        </form>
                    </div>
                </div>
            </div>
