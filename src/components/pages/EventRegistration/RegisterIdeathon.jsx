...
export default function RegisterIdeathon() {
    ...
    registerIdeathonData.pid1 = userData.regID
    const handleSubmit = async (e, eventName) => {
        e.preventDefault()
        try {
            const res = await axios.post(`${process.env.REACT_APP_API_KEY}/eventRegistration/${eventName}/${participantId}`, registerIdeathonData)
